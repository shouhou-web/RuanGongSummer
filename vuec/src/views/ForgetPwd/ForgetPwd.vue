            ...
            <div class="center-wrap">
              <div>
                ...
                <div class="login-main">
                  ...
                  >
                    <input
                      ...
                      v-bind:class="{
                        ...
                        'success-code-style': code_info == 1,
                        'error-code-style': code_info == 2,
                        'empty-code-style': code_info == 3,
                      }"
                      v-model="code"
                    />
                    <my-button type="disabled" v-if="!email" @click="warnEmail">
                      发送验证码
                    </my-button>
                    <my-button
                      type="timer"
                  ...
                  <a v-show="isShow" @click="confirmCode" class="btn">
                    confirm
                  </a>
                </div>
                <div v-show="!isShow">
...
export default {
  ...
  methods: {
    ...
    resetPassword() {
      ...
      resetPwd(this.email, this.password, this.password_again).then((res) => {
